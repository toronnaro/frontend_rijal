                    ...
                    <div class="card-body">
                        <form action="/updatefoto/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="string" name="judulfoto" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ $data->judulfoto }}">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Deskripsi Foto</label>
                                <input type="text" name="deskripsifoto" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ $data->deskripsifoto }}">
                            </div>
                            <div class="mb-3">
